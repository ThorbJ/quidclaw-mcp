...
- **MCP 客户端** — Claude Desktop、Claude Code、Cursor、Codex、VS Code 或其他支持 [MCP](https://modelcontextprotocol.io/) 的应用。

## 开始使用

在你的 MCP 客户端配置中添加 QuidClaw。选择你使用的客户端：
...
配置完成后，客户端会在首次启动时自动下载并运行 QuidClaw。
